                  ...
                  <div class="tab-pane" id="settings">
                    <form class="form-horizontal" action="/akun/{{auth()->user()->id}}/update2" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="form-group row {{$errors->has('no_hp') ? 'has-error' : ''}}">
                        ...
                        <div class="col-sm-10">
                          <input type="number" min="0" class="form-control" id="inputSkills" required="" placeholder="no hp" value="{{auth()->user()->no_hp}}" name="no_hp">
                          @if($errors->has('no_hp'))
                      ...
                      <div class="form-group row {{$errors->has('avatar') ? 'has-error' : ''}}">
                        ...
                        <div class="col-sm-10">
                          <input type="file" class="form-control" id="inputSkills" placeholder="no hp" name="avatar" value="{{auth()->user()->avatar}}">
